...
try {
    ...
    MilesTravelled INT(4))"
    );
    $stmt1->execute();
    $stmt1->closeCursor();
    $stmt5 = $conn->prepare("INSERT INTO TblBookings(BookingID,StaffID,VehicleID,Bookingstartdate,Bookingenddate,StartTime,EndTime,DriverID,Capacityrequired,Status,Destination,CostcodeID,MilesTravelled)VALUES
    (NULL,3,NULL,'2024-10-01','2024-10-01','09:00:00','17:00:00',NULL,5,'Pending','Local sports event','S002',0),
    (NULL,3,NULL,'2024-10-15','2024-10-15','08:00:00','18:00:00',NULL,17,'Pending','DofE expedition','S003',0),
    (NULL,3,NULL,'2024-11-01','2024-11-01','10:00:00','16:00:00',NULL,9,'Pending','Rugby match','S004',0),
    (NULL,2,NULL,'2024-11-01','2024-11-01','10:00:00','16:00:00',NULL,9,'Pending','Football match','S004',0),
    (NULL,1,NULL,'2024-11-01','2024-11-01','10:00:00','16:00:00',NULL,9,'Pending','Badminton match','S004',0),
    (NULL,3,NULL,'2024-11-01','2024-11-01','10:00:00','16:00:00',NULL,9,'Pending','Netball match','S004',0),
    (NULL,3,NULL,'2024-12-01','2024-12-01','07:00:00','19:00:00',NULL,52,'Pending','Silicon Valley trip','X005',0)
